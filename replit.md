...
- 2026-04-23: CSVインポート前プレビュー機能追加（/api/subscriptions/import-preview ドライランAPI、ファイル選択時に自動実行、確認ダイアログ付きインポートフロー）
- 2026-04-23: サブスクリプションに管理ID（managementId）付与 - 8文字英数字のサーバー自動生成ID、CSVエクスポート先頭列に出力、インポート時の重複判定キーとして使用
